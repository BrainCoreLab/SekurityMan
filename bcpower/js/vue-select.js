!function (t, e) {
    ...
    return function (t) {
        ...
        "use strict";
        n.r(e);
        var o = n(0), i = n.n(o), r = n(1), s = n.n(r), a = n(3), l = n.n(a), c = {
            props: {autoscroll: {type: Boolean, default: !0}}, watch: {
                ...
                maybeAdjustScroll: function () {
                    ...
                    if (e) {
                        var n = this.getDropdownViewport(), o = e.getBoundingClientRect(), i = o.top, r = o.bottom,
                            s = o.height;
        ...
        var d = {
            ...
            inserted: function (t, e, n) {
                var o = n.context;
                if (o.appendToBody) {
                    var i = o.$refs.toggle.getBoundingClientRect(), r = i.height, s = i.top, a = i.left, l = i.width;
        ...
        var _ = {
            components: m({}, d), mixins: [c, u, p], directives: {appendToBody: f}, props: {
                ...
                calculatePosition: {
                    type: Function, default: function (t, e, n) {
                        var o = n.width, i = n.top, r = n.left;
